...
const Header = () => {
  return (
    <div className="w-full h-[100vh]">
      <Navbar />
      <header className="w-full h-[82vh] relative">
        <div className="w-full px-[12%] relative bg-black/20 z-30">
          <div className="w-full h-[10vh] flex justify-between items-center">
            <ul
              id="krub-semibold"
              className="flex w-[40%] items-center justify-between cursor-pointer"
            >
            ...
            <ul className="w-[40%] flex items-center justify-between cursor-pointer">
              ...
              <button
                id="krub-semibold"
                className="w-[180px] px-[10%] py-[5.8%] text-center bg-white text-xs font-semibold"
              >
                Request Quote
              </button>
            </ul>
        ...
        <div className="px-[12%] w-full h-[72vh] flex items-center relative z-30">
          <div className="">
            <div className="flex bg-black/20 w-[220px]">
              <div className="w-[4px] h-[20px] bg-gradient-to-r from-[#FFDA56] to-[#FFD7A6]"></div>
              <p
                id="rubik-regular"
                className="text-[#ffffff] text-xs text-center px-[9px]"
              >
            ...
            <h1
              id="rubik-bold"
              className="font-[800] text-[45px] text-[#ffffff] mt-[-10px]"
            >
              Your Gateway
            </h1>
            <h1
              id="rubik-bold"
              className="font-[800] text-[45px] text-[#ffffff] my-[-25px]"
            >
              to any Destination
            </h1>
            <h1
              id="rubik-bold"
              className="font-[800] text-[45px] text-[#ffffff]"
            >
              in the World
            </h1>
            <p
              id="krub-medium"
              className="text-xs text-[#ffffff] max-w-[388px] mt-[-10px] mb-1"
            >
            ...
            <button
              id="button"
              className="relative w-[194px] h-[60px] bg-gradient-to-r from-[#FFDA56] to-[#FFD7A6]"
            >
              <p id="krub-semibold" className="text-center text-[#23212A]">
                Explore More
              </p>
            </button>
          </div>
        </div>
        <img src={headerbg} alt="header section background" className="object-cover w-full h-full absolute top-0 left-0 z-10" />
      </header>
    </div>
  );
};
