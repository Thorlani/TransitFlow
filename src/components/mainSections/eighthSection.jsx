    ...
    <section className="w-full h-fit px-[12%] py-[6%]">
      <div className="w-full flex flex-col justify-center items-center">
        <div className="flex bg-black/20 w-[50px]">
          ...
          <p id="rubik-regular" className="text-[#1C1F35] text-[10px] text-center px-[4px]">
            Our Blog
          </p>
        </div>
        <h3 id="rubik-semibold" className="text-[#1C1F35] text-2xl font-bold text-center">
          Our Latest News
        </h3>
        <div className="flex justify-between w-full px-[8%] py-[4%] border-t-[1.5px] border-black/20 mt-[20px]">
          <div className="flex w-[45%] justify-between items-start">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <p id="krub-medium" className="text-[10px]">September</p>
            </div>
          </div>
          <div className="w-[1.5px] h-[200px] bg-black/20"></div>
          <div className="w-[40%]">
            <h5 id="rubik-regular" className="font-medium text-xl max-w-[270px] text-[#1C1F35]">
            ...
            <ul id="krub-medium" className="list-disc text-xs mt-[10px] ml-[15px] font-medium">
          ...
          <div className="flex w-[45%] justify-between items-start">
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                ...
                height={40}
              />
              <span id="rubik-bold" className="font-bold text-2xl text-[#1C1F35]">12</span>
              <p id="krub-medium" className="text-[10px]">September</p>
            </div>
          </div>
          <div className="w-[1.5px] h-[200px] bg-black/20"></div>
          <div className="w-[40%]">
            <h5 id="rubik-regular" className="font-medium text-xl max-w-[270px] text-[#FFBE34]">
          ...
          <div className="flex w-[45%] justify-between items-start">
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                ...
                height={40}
              />
              <span id="rubik-bold" className="font-bold text-2xl text-[#1C1F35]">25</span>
              <p id="krub-medium" className="text-[10px]">September</p>
            </div>
          </div>
          <div className="w-[1.5px] h-[200px] bg-black/20"></div>
          <div className="w-[40%]">
            <h5 id="rubik-regular" className="text-xl max-w-[270px] text-[#1C1F35]  ml-[15px] font-medium">
            ...
            <ul className="list-disc text-xs mt-[10px]">
              <li>Urgent transport solutions</li>
              <li>Reliable & experienced staffs</li>
              <li>Urgent transport solutions</li>
              <li>Reliable & experienced staffs</li>
      ...
      <div id="krub-semibold" className="w-full flex justify-center py-[4%] border-t-[1.5px] border-black/20 mt-[20px]">
